<div class="forms-container py-2 bg-white rounded shadow">
    <div class="row">
        ...
        <div class="col">
            <form action="/color/store" id="newColorPost" method="post" class="form-floating px-5 py-5">
                ...
                <div class="row">
                    ...
                    <div class="col">
                        <a href="/color/index" class="btn btn-outline-danger">Cancel</a>
                        <button type="button" onclick="saveOrUpdateColorValidate('newColorPost')" class="btn btn-outline-info">Save</button>
                    </div>
                </div>
            </form>
        </div>
