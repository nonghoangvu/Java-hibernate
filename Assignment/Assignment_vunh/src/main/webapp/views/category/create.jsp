<div class="forms-container py-2 bg-white rounded shadow">
    <div class="row">
        ...
        <div class="col">
            <form action="/category/store" method="post" id="newCategoryPost" class="form-floating px-5 py-5">
                <h2 class="fw-bold text-center mb-5">Create New Category</h2>
                <div class="row">
                    <div class="col-12">
                    ...
                    <div class="col">
                        <a href="/category/index" class="btn btn-outline-danger">Cancel</a>
                        <button onclick="saveOrUpdateCategoryValidate('newCategoryPost')" type="button" class="btn btn-outline-info">Save</button>
                    </div>
                </div>
            </form>
        </div>
