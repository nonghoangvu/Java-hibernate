...
<div class="container py-2 bg-white rounded shadow">
    <c:if test="${sessionScope.user.role}">
        <div class="text-end mt-3 mb-3">
            <a href="/category/create" class="btn btn-outline-secondary">New</a>
        </div>
    </c:if>
    ...
    <div>
        <table class="table table-bordered table-hover mt-4">
            ...
            <tbody>
            <c:forEach items="${listCategory}" var="c" varStatus="i">
                ...
                <tr>
                    ...
                    <c:if test="${sessionScope.user.role}">
                        <td class="text-center">
                            <a href="/category/delete?id=${c.id}" class="btn btn-outline-danger border-0"><i class="bi bi-trash"></i></a>
                            <a href="/category/edit?id=${c.id}" class="btn btn-outline-warning border-0"><i class="bi bi-pencil-square"></i></a>
                        </td>
                    </c:if>
                </tr>
            </c:forEach>
